...
@section('center')
    <div class="col-sm-6">
        <!-- <div class="text-center">
            <img class="img-circle" src="{{asset(auth()->user()->image?? '/images/no user.png')}}" height="200" width="300">
            <br><br>
        </div> -->
        <form action="{{route('profile.edit')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center" onmouseover="showUploadButton();" onmouseout="hideUploadButton();">
                <div class="form-group button-image">
                    <img class="img-circle" src="{{asset(auth()->user()->image?? '/images/no user.png')}}">
